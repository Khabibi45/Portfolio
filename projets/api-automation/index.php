...
<head>
    ...
    <title>API Automation | Camil Belmehdi</title>
    ...
    <style>
        .hero-bg {
            background-image: url('https://images.unsplash.com/photo-1558494949-ef010cbdcc31?q=80&w=1600');
    ...
    <section class="h-screen relative flex items-center justify-center overflow-hidden">
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-4 text-center">
            ...
            <p class="text-xl text-gray-300 max-w-2xl mx-auto mb-10">
                Orchestration de processus métiers complexes. Intégrations API, synchronisation de données et
